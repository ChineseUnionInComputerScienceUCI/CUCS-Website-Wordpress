	...
	jQuery(document).ready(function(){
		...
		if( jQuery( 'body' ).hasClass( 'wp-customizer' ) ) {
			...
			jQuery('input[type=radio]').change(function() {
				...
				if(jQuery('#thinkup_homepage_sliderswitch-buttonsetoption4').is(":checked")){
					jQuery('#thinkup_redux_variables-thinkup_homepage_sliderimage1_info').addClass('thinkup-show').removeClass('thinkup-hide');
					jQuery('#thinkup_redux_variables-thinkup_homepage_sliderimage1_image').addClass('thinkup-show').removeClass('thinkup-hide');
					jQuery('#thinkup_redux_variables-thinkup_homepage_sliderimage1_title').addClass('thinkup-show').removeClass('thinkup-hide');
					jQuery('#thinkup_redux_variables-thinkup_homepage_sliderimage1_desc').addClass('thinkup-show').removeClass('thinkup-hide');
					jQuery('#thinkup_redux_variables-thinkup_homepage_sliderimage1_link').addClass('thinkup-show').removeClass('thinkup-hide');
					jQuery('#thinkup_redux_variables-thinkup_homepage_sliderimage2_info').addClass('thinkup-show').removeClass('thinkup-hide');
					jQuery('#thinkup_redux_variables-thinkup_homepage_sliderimage2_image').addClass('thinkup-show').removeClass('thinkup-hide');
					jQuery('#thinkup_redux_variables-thinkup_homepage_sliderimage2_title').addClass('thinkup-show').removeClass('thinkup-hide');
					jQuery('#thinkup_redux_variables-thinkup_homepage_sliderimage2_desc').addClass('thinkup-show').removeClass('thinkup-hide');
					jQuery('#thinkup_redux_variables-thinkup_homepage_sliderimage2_link').addClass('thinkup-show').removeClass('thinkup-hide');
					jQuery('#thinkup_redux_variables-thinkup_homepage_sliderimage3_info').addClass('thinkup-show').removeClass('thinkup-hide');
					jQuery('#thinkup_redux_variables-thinkup_homepage_sliderimage3_image').addClass('thinkup-show').removeClass('thinkup-hide');
					jQuery('#thinkup_redux_variables-thinkup_homepage_sliderimage3_title').addClass('thinkup-show').removeClass('thinkup-hide');
					jQuery('#thinkup_redux_variables-thinkup_homepage_sliderimage3_desc').addClass('thinkup-show').removeClass('thinkup-hide');
					jQuery('#thinkup_redux_variables-thinkup_homepage_sliderimage3_link').addClass('thinkup-show').removeClass('thinkup-hide');
					jQuery('#thinkup_redux_variables-thinkup_homepage_sliderpresetwidth').addClass('thinkup-show').removeClass('thinkup-hide');
					jQuery('#thinkup_redux_variables-thinkup_homepage_sliderpresetheight').addClass('thinkup-show').removeClass('thinkup-hide');
				}
				else if(jQuery('#thinkup_homepage_sliderswitch-buttonsetoption4').not(":checked")){
					jQuery('#thinkup_redux_variables-thinkup_homepage_sliderimage1_info').addClass('thinkup-hide').removeClass('thinkup-show');
					jQuery('#thinkup_redux_variables-thinkup_homepage_sliderimage1_image').addClass('thinkup-hide').removeClass('thinkup-show');
					jQuery('#thinkup_redux_variables-thinkup_homepage_sliderimage1_title').addClass('thinkup-hide').removeClass('thinkup-show');
					jQuery('#thinkup_redux_variables-thinkup_homepage_sliderimage1_desc').addClass('thinkup-hide').removeClass('thinkup-show');
					jQuery('#thinkup_redux_variables-thinkup_homepage_sliderimage1_link').addClass('thinkup-hide').removeClass('thinkup-show');
					jQuery('#thinkup_redux_variables-thinkup_homepage_sliderimage2_info').addClass('thinkup-hide').removeClass('thinkup-show');
					jQuery('#thinkup_redux_variables-thinkup_homepage_sliderimage2_image').addClass('thinkup-hide').removeClass('thinkup-show');
					jQuery('#thinkup_redux_variables-thinkup_homepage_sliderimage2_title').addClass('thinkup-hide').removeClass('thinkup-show');
					jQuery('#thinkup_redux_variables-thinkup_homepage_sliderimage2_desc').addClass('thinkup-hide').removeClass('thinkup-show');
					jQuery('#thinkup_redux_variables-thinkup_homepage_sliderimage2_link').addClass('thinkup-hide').removeClass('thinkup-show');
					jQuery('#thinkup_redux_variables-thinkup_homepage_sliderimage3_info').addClass('thinkup-hide').removeClass('thinkup-show');
					jQuery('#thinkup_redux_variables-thinkup_homepage_sliderimage3_image').addClass('thinkup-hide').removeClass('thinkup-show');
					jQuery('#thinkup_redux_variables-thinkup_homepage_sliderimage3_title').addClass('thinkup-hide').removeClass('thinkup-show');
					jQuery('#thinkup_redux_variables-thinkup_homepage_sliderimage3_desc').addClass('thinkup-hide').removeClass('thinkup-show');
					jQuery('#thinkup_redux_variables-thinkup_homepage_sliderimage3_link').addClass('thinkup-hide').removeClass('thinkup-show');
					jQuery('#thinkup_redux_variables-thinkup_homepage_sliderpresetwidth').addClass('thinkup-hide').removeClass('thinkup-show');
					jQuery('#thinkup_redux_variables-thinkup_homepage_sliderpresetheight').addClass('thinkup-hide').removeClass('thinkup-show');
				}
