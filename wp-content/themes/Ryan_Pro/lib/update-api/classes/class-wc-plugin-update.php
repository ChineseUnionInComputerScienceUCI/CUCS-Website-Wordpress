...
class ThinkUp_Update_Theme_Update_API_Check {
...
//		 print_r($response); exit;
         ...
         * Adding admin notice, if we get some message returned
         */
        if (isset($response->tut_message)) {
			set_theme_mod( $tut_message_API, $response->tut_message );
		}
	...
	public function expired_license_error_notice( $message ){
		...
		$plugin_name = isset( $plugins[$this->product_id] ) ? $plugins[$this->product_id]['Name'] : $this->product_id;
