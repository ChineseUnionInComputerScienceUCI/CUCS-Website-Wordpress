...
class thinkup_builder_itemtestimonial extends WP_Widget {

	/* Register widget description. */
	public function __construct() {
		$widget_ops = array('classname' => 'thinkup_builder_itemtestimonial', 'description' => 'Add a testimonial item to your content.' );
		parent::__construct('thinkup_builder_itemtestimonial', 'Testimonial (Item)', $widget_ops);
	}
	...
	function form($instance) {
		...
		echo '<p><label for="' . $this->get_field_id('style') . '" style="display: inline-block;width: 150px;" >Choose Style:</label>
		...
		echo '<p><label for="' . $this->get_field_id('links') . '" style="display: inline-block;width: 150px;" >Toggle Links:</label>
	...
	function widget($args, $instance) {
		...
		echo do_shortcode( '[item_testimonial id="' . $post_id . '" style="' . $style . '" links="' . $links . '"]' );
...
add_action( 'widgets_init', create_function('', 'return register_widget("thinkup_builder_itemtestimonial");') );
