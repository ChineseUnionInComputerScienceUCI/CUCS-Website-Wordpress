...
class thinkup_builder_carouseltestimonial extends WP_Widget {

	/* Register widget description. */
	public function __construct() {
		$widget_ops = array('classname' => 'thinkup_builder_carouseltestimonial', 'description' => 'Add a testimonial carousel to your content.' );
		parent::__construct('thinkup_builder_carouseltestimonial', 'Testimonial (Carousel)', $widget_ops);
	}
	...
	function form($instance) {
		...
		echo '<p><label for="' . $this->get_field_id('items') . '" style="display: inline-block;width: 150px;" >Items:</label>
			...
			<option '; ?><?php if($items == "7") { echo "selected"; } ?><?php echo ' value="7">7</option>
			<option '; ?><?php if($items == "8") { echo "selected"; } ?><?php echo ' value="8">8</option>
			<option '; ?><?php if($items == "9") { echo "selected"; } ?><?php echo ' value="9">9</option>
			<option '; ?><?php if($items == "10") { echo "selected"; } ?><?php echo ' value="10">10</option>
			</select>
		</p>';
		...
		echo '<p><label for="' . $this->get_field_id('links') . '" style="display: inline-block;width: 150px;" >Links:</label>
			<select name="' . $this->get_field_name('links') . '" id="' . $this->get_field_id('links') . '" style="display: inline-block;width: 200px;margin: 0;" >
			<option '; ?><?php if($links == "off") { echo "selected"; } ?><?php echo ' value="off">off</option>
			<option '; ?><?php if($links == "on") { echo "selected"; } ?><?php echo ' value="on">on</option>
			</select>
		</p>';
	...
	function widget($args, $instance) {
		...
		echo do_shortcode( '[carousel_testimonial items="' . $items .'" scroll="' . $scroll . '" speed="' . $speed . '" effect="' . $effect . '" category="' . $category . '" style="' . $style . '" links="' . $links . '"]' );
...
add_action( 'widgets_init', create_function('', 'return register_widget("thinkup_builder_carouseltestimonial");') );
