				<?php
					$text = '<span class="noselection thinkupshortcodes_media_select button">'.__('Select Image','thinkupshortcodes').'</span>';
					$bg = '';
					if(!empty($value)){
						...
						if(floatval($attachment[0]) > 0){
							...
							$text = '<span class="remove">&times;</span>'.$setsize.$sizebuttons.'<span class="filechanger-btn thinkupshortcodes_media_select changer">'.__('Change Image','thinkupshortcodes').'</span>';
							...
							$text = '<span class="remove">&times;</span><span class="filechanger-btn thinkupshortcodes_media_select changer">'.__('Change Image','thinkupshortcodes').'</span><span class="preview">'.$sizes[0].'x'.$sizes[1].'</span>';
					...
					echo '	<div class="image-field-thinkupshortcodes imgpreview" '.$bg.'>'.$text.'</div>';
					echo '</div>';
					?>