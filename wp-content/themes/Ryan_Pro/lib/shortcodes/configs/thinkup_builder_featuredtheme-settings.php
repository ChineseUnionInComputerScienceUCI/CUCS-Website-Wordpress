...
$group = array(
	...
	'fields' => array(
		...
		'overlay'	=>	array(
			'label'		=> 	__('Enable Overlay','thinkupshortcodes'),
          'caption'   =>  '',
			'type'		=>	'onoff',
