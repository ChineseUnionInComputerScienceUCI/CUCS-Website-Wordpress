...
/**
*
* fieldconfig for thinkupshortcodes/Advanced List
*
...
$group = array(
	'label' => __('Advanced List','thinkupshortcodes'),
	'id' => '121440159',
	'master' => 'list_item',
	'fields' => array(
		'list_item'	=>	array(
			'label'		=> 	__('List Text','thinkupshortcodes'),
			'caption'	=>	__('List Text','thinkupshortcodes'),
			'type'		=>	'textfield',
			'default'	=> 	'',
		),
		'icon'	=>	array(
			'label'		=> 	__('List Icon','thinkupshortcodes'),
			'caption'	=>	__('List Icon','thinkupshortcodes'),
			'type'		=>	'dropdown',
		...
		'indent'	=>	array(
			'label'		=> 	__('List Item Indent (px)','thinkupshortcodes'),
			'caption'	=>	__('List Item Indent (px)','thinkupshortcodes'),
			'type'		=>	'slider',
			'default'	=> 	'0,100|0',
			'inline'	=> 	true,
		),
