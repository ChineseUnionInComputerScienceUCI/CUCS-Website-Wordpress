...
$group = array(
	...
	'fields' => array(
		'list_item'	=>	array(
			'label'		=> 	__('Text','thinkupshortcodes'),
			'caption'	=>	__('Text shown for each list point.','thinkupshortcodes'),
			'type'		=>	'textfield',
			'default'	=> 	'',
		),
		'icon'	=>	array(
			'label'		=> 	__('Icon','thinkupshortcodes'),
			'caption'	=>	__('Choose a list icon.','thinkupshortcodes'),
			'type'		=>	'dropdown',
		...
		'indent'	=>	array(
			'label'		=> 	__('Indent (px)','thinkupshortcodes'),
