...
$group = array(
	...
	'fields' => array(
		'id'	=>	array(
			'label'		=> 	__('Youtube ID','thinkupshortcodes'),
			'caption'	=>	__('Specify the YouTube video ID.','thinkupshortcodes'),
			'type'		=>	'textfield',
			'default'	=> 	'',
		),
		'thumb'	=>	array(
			'label'		=> 	__('Thumbnail URL','thinkupshortcodes'),
			'caption'	=>	__('Specify the URL to your thumbnail image. Leave blank to show YouTube video thumbnail.','thinkupshortcodes'),
			'type'		=>	'textfield',
			'default'	=> 	'',
		),
		'title'	=>	array(
