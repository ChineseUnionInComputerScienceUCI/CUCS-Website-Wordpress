...
/**
*
* fieldconfig for thinkupshortcodes/Pricing Items
*
...
$group = array(
	'label' => __('Pricing Items','thinkupshortcodes'),
	'id' => '15106137',
	'master' => 'item',
	'fields' => array(
		'item'	=>	array(
			'label'		=> 	__('Item','thinkupshortcodes'),
			'caption'	=>	__('Item','thinkupshortcodes'),
			'type'		=>	'smalltextfield',
			'default'	=> 	'',
		),
		'icon'	=>	array(
			'label'		=> 	__('Icon','thinkupshortcodes'),
			'caption'	=>	__('Icon','thinkupshortcodes'),
			'type'		=>	'dropdown',
