...
$group = array(
	...
	'fields' => array(
		'title'	=>	array(
			'label'		=> 	__('Tab Title','thinkupshortcodes'),
			'caption'	=>	__('Title of the tab box.','thinkupshortcodes'),
			'type'		=>	'textfield',
			'default'	=> 	'',
		),
		'tab'	=>	array(
			'label'		=> 	__('Tab Content','thinkupshortcodes'),
			'caption'	=>	__('Content to be shown in the tab area.','thinkupshortcodes'),
			'type'		=>	'textbox',
			'default'	=> 	'',
		),
		'icon'	=>	array(
			'label'		=> 	__('Icon','thinkupshortcodes'),
			'caption'	=>	__('Select a Font Awesome icon to show in the tab title.','thinkupshortcodes'),
			'type'		=>	'dropdown',
